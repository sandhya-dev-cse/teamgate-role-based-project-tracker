...
export default function LoginPage() {
  ...
  async function handleLogin(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      /*
       * Make sure there isn't an old Cognito session.
       * This allows switching between test accounts.
       */
      try {
        ...
        <section className="hidden w-1/2 flex-col justify-between border-r border-white/10 bg-[#07101f] p-12 lg:flex">
          ...
          <div className="max-w-md">
            ...
            <h2 className="mt-4 text-4xl font-bold leading-tight">
              ...
              <span className="text-blue-500"> role-based access.</span>
            </h2>

            <p className="mt-5 text-sm leading-6 text-slate-400">
              TeamGate uses AWS Cognito authentication and server-side
              authorization to protect your workspace.
            </p>
          </div>
