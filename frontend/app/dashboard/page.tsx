...
export default function DashboardPage() {
  ...
  const [userEmail, setUserEmail] = useState("TeamGate User");
  ...
  useEffect(() => {
    async function loadDashboard() {
      try {
        ...
        /* USER EMAIL */
        setUserEmail(meData?.email || "TeamGate User");
        ...
        const formattedProjects: Project[] = projectList.map(
          (project: ApiProject) => ({
          ...
          <div className="px-8 py-9">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-xs leading-5 text-gray-600">
                      {userRole === "admin"
                        ? "You can manage projects, delete projects, and control workspace roles."
                        : userRole === "manager"
                          ? "You can view, create, and edit projects in your workspace."
                          : "You can view projects assigned to your workspace."}
                    </p>
                  </div>
              ...
              <div className="rounded-2xl border border-white/[0.07] bg-gradient-to-br from-blue-950/20 to-[#070b14] p-6">
                ...
                <p className="mt-2 text-xs leading-5 text-gray-600">
                  TeamGate automatically controls actions based on your
                  assigned role.
                </p>
              </div>
            </div>
